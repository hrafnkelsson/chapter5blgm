...
mu = mean(magnb) - mmin;
t = mmin:0.01:6.5;
estcdf = 1 - exp(-(t - mmin)/mu);
plot(t,estcdf,'r-')
hold

figure(2)
cdfplot(magnb), hold
[xis,xisconf] = gpfit(magnb - mmin);
xi = xis(1);
s = xis(2);
t = mmin:0.01:6.5;
estcdf2 = gpcdf(t - mmin,xi,s);
plot(t,estcdf2,'r-')
hold
[xisconf(1,1) xi xisconf(2,1)]

figure(4)
plot3(longb,latb,magnb,'b.')
grid
